...
{
public:
    explicit WinMMap(char const *filename);
    ~WinMMap();
...
inline WinMMap::WinMMap(char const *filename)
    : m_address(0), m_size(0), m_file(INVALID_HANDLE_VALUE), m_mapping(INVALID_HANDLE_VALUE)
{
